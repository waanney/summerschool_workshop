...
class FileInput(BaseModel):
    ...
    file_path: str = Field("src/data/mock_data/Kich_ban_Demo_Mini_QA_Agent.docx", description="Path to the file to be read. Supports pdf. Default src/data/mock_data/Kich_ban_Demo_Mini_QA_Agent.docx")
...
def read_file_tool(input_data: FileInput) -> FileContentOutput:
    # Reads the content of a specified file (CSV or PDF).
    #
