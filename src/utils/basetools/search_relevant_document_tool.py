...
class SearchRelevantDocumentOutput(BaseModel):
    documents: List[str] = Field(
        ...,
        description="A list of relevant document chunks retrieved from the vector database.",
    )
...
def search_relevant_document(
    ...
    Args:
        input (SearchRelevantDocumentInput): The input parameters for the search.

    Returns:
        SearchRelevantDocumentOutput: The output containing the relevant documents.
    """
