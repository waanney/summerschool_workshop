...
class MilvusIndexer:
    ...
    def create_collection(self, data_sample=None):
        ...
        # Add text fields and embedding fields for each category
        functions = []
        for category in categories:
            ...
            # Create BM25 function for each category
            functions.append(
                Function(
    ...
    def insert_data(self, data):
        ...
        if isinstance(category_texts, dict):
            ...
            # Schema order for categories ['Question', 'Answer']:
            # ID(auto), Question, Question_dense, Question_sparse(auto), Answer, Answer_dense, Answer_sparse(auto)
            # We need to provide: Question, Question_dense, Answer, Answer_dense
            entities = []

            for category in categories:
                entities.append(category_texts[category])  # Text field
                entities.append(category_embeddings[category])  # Dense embedding
                # Sparse embedding is auto-generated by BM25 function
